...
UROLOGY_ICD10_WHITELIST: set[str] = {
    ...
    "N50",
    "N51",
    "N52",  # 勃起功能障礙（erectile dysfunction，D6）
    # 泌尿症狀 R30–R39
    "R30",  # 排尿疼痛
    "R31",  # 血尿
    "R32",  # 尿失禁 NOS
    ...
    "R37",
    "R39",  # 其他泌尿系統症狀
    # 腫瘤標記異常 R97（D6：PSA 升高應對映 R97.20）。
    # E7 決策 4 註記：本驗證層採 3 碼前綴比對，R97 無法區分
    # R97.20（PSA 升高）與 R97.1（CA-125 升高）——泌尿情境以 PSA 為大宗，
    # 拍板接受此粗粒度；如需 4 碼精度須擴充 validator 的比對邏輯。
    "R97",
    # 下腹痛（泌尿相關鑑別）
    "R10",
    # 泌尿生殖系惡性腫瘤 C60–C68
