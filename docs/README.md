...
| 一場問診的資料落地（含 **admin 軟刪除**的欄位與覆蓋範圍） | [session_data_inventory.md](session_data_inventory.md) |
...
| 活的 backlog | [TODO.md](TODO.md)；2026-07-27 真跑修復與六條測試設計教訓見 §R／§R-lessons；2026-08-23 三項使用者需求（登入頁精簡／admin 刪除問診／場次日曆）與其留下的坑見 §W |
