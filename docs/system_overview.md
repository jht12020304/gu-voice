...
> - [`database_spec.md`](archive/spec_2026-04/database_spec.md) — 資料表詳細規格
> - [`api_spec.md`](archive/spec_2026-04/api_spec.md) — API 端點規格
...
> 詳細欄位請見 [`database_spec.md`](archive/spec_2026-04/database_spec.md)。
...
> 以下為 2026-04-17 的快照，僅供史料；活的 backlog 見 [TODO.md](TODO.md)。
