...
| 3 | Red Flag detector 改吃共用常數 | ✅ 完成 | `734cfd7` | 29/29 tests passing;修 P2-E |
| 2 | Conversation 擴充 HPI 10 欄 + 補問 FH/SH/RoS | ✅ 完成 | `dad998c` | 37/37 tests passing;修 P0-B、P1-D |
| 4 | SOAP confidence_score 不扣 FH/SH/RoS 分 | ✅ 完成 | _pending_ | 41/41 tests passing;P0-B 收尾 |
