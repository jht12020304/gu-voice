...
const mockReport: SOAPReport = {
  ...
  plan: {
    recommendedTests: [
      { testName: '膀胱鏡檢查', rationale: '排除膀胱腫瘤', urgency: 'this_week', clinicalReasoning: '患者為45歲男性，有顯著吸菸史（20包年），出現持續性肉眼血尿。根據美國泌尿科學會(AUA)微血尿評估指引，40歲以上具有血尿危險因子（吸菸、男性）的患者，應進行膀胱鏡檢查以排除膀胱惡性腫瘤。吸菸是膀胱癌最重要的可改變危險因子，即使已戒菸5年，殘餘風險仍然偏高。' },
      { testName: '腎臟超音波', rationale: '評估上泌尿道', urgency: 'this_week', clinicalReasoning: '肉眼血尿的來源可能為上泌尿道（腎臟、輸尿管）或下泌尿道（膀胱、尿道）。腎臟超音波為非侵入性檢查，可快速評估是否有腎臟腫塊、水腎、結石等上泌尿道病灶。患者無典型腎絞痛，但仍需排除無痛性腎臟腫瘤的可能。此檢查與膀胱鏡互補，共同涵蓋完整泌尿道評估。' },
